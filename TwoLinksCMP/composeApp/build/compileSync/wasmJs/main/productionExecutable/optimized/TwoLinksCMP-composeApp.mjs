...
import { importObject, setWasmExports } from './TwoLinksCMP-composeApp.import-object.mjs'
...
const wasmFilePath = './TwoLinksCMP-composeApp.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./TwoLinksCMP-composeApp.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
