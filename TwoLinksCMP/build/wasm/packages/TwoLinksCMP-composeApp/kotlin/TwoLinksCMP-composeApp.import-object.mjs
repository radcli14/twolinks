...
import * as d2FzbTpqcy1zdHJpbmc from './TwoLinksCMP-composeApp.js-builtins.mjs';
...
const js_code = {
    ...
    'com.dcengineer.twolinks.initSceneViewAsync' : initSceneViewAsync,
    'com.dcengineer.twolinks.addDirectionalLight' : addDirectionalLight,
    'com.dcengineer.twolinks.createBox' : createBox,
    'com.dcengineer.twolinks.createCylinder' : createCylinder,
    'com.dcengineer.twolinks.setEntityColor' : setEntityColor,
    'com.dcengineer.twolinks.setEntityMaterialProperties' : setEntityMaterialProperties,
    'com.dcengineer.twolinks.loadModelWithScaleAsync' : loadModelWithScaleAsync,
    'com.dcengineer.twolinks.__convertKotlinClosureToJsClosure_((Js,Js)->Unit)' : (f) => getCachedJsObject(f, (p0, p1) => wasmExports['__callFunction_((Js,Js)->Unit)'](f, p0, p1)),
    'com.dcengineer.twolinks.setEntityTransformJs' : setEntityTransform,
    'com.dcengineer.twolinks.loadEnvironment' : loadEnvironment,
    'com.dcengineer.twolinks.loadSkybox' : loadSkybox
}
